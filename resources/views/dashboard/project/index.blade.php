                    ...
                    <section class="row">
                        <div class="col">
                            <div class="d-flex justify-content-between">
                                <form action="/dashboard/project/rooms" class="d-flex   col-md-8 " role="search">
                                    @if (request('project'))
                                ...
                                <a href="/dashboard/project/create" class="btn btn-primary">{{ $subteks }}</a>
                            </div>
                            <div class="container mt-md-3 ">
                                <div class="row">
                                    @foreach ($list as $project)
                                        <div class="col-4 mb-lg-4">
                                            <a href="/dashboard/project/rooms?project={{ $project->name}}">
                                                <div class="card text-bg-dark">
                                                    <img src="{{ $project->getPhoto() }}" class="card-img"
                                                        alt="{{ $project->name }}">

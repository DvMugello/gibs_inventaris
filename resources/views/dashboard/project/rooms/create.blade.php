                ...
                <section class="row">
                    <div class="col">
                        <div class="card mt-md-0">
                            <main class="col-md-12 col-lg-12 px-md-2">
                                <div
                                ...
                                <div class="table-responsive small col-lg-auto">
                                    <table class="table table-striped table-sm">
                                        <form method="post" action="/dashboard/project/rooms" enctype="multipart/form-data">
                                            @csrf
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                <label for="project" class="form-label">Gedung</label>

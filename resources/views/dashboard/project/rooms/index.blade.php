                        ...
                        <div class="col">
                            <thead>
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="/dashboard/project/rooms/create" class="btn btn-primary">Create Rooms</a>
                                </div>
                            </thead>
                            <tbody>
                                            ...
                                            <div class="col-md-3">
                                                <div class="card">
                                                    <div class="card-body text-center">
                                                        <a href="/dashboard/inventaris?rooms={{ $rooms->name }}"
                                                            class="card-link badge text-bg-primary">GIP-{{ $rooms->number }}</a>
                                                        <a href="/dashboard/inventaris?rooms={{ $rooms->name }}"
                                                            class="card-link text-bold">{{ $rooms->name }}</a>
                                                        <a href="/dashboard/inventaris?rooms={{ $rooms->name }}" class="card-link">Go To
                                                            Inventaris</a>
                                                    </div>
                                                </div>
                                            </div>
